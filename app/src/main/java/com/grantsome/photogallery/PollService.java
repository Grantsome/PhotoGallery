...
public class PollService extends IntentService {
    ...
    public static final String ACTION_SHOW_NOTIFICATION = "com.grantsome.photogallery.SHOW_NOTIFICATION";

    public static final String PREM_PRIVATE = "com.grantsome.photogallery.PRIVATE";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String query = QueryPrefences.getStoredQuery(this);
        String lastResultId = QueryPrefences.getPrefLastResultId(this);
        List<GalleryItem> galleryItemList;
        if(query==null){
            galleryItemList = new HttpUtil().fetchRecentPhotos();
        }else {
            galleryItemList = new HttpUtil().searchPhotos(query);
        }
        ...
        QueryPrefences.setPrefLastResultId(this,resultId);
